...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 container-tight px-4 md:px-8 text-center">
        ...
        >
          <p className="text-xl md:text-2xl lg:text-3xl text-muted-foreground font-light tracking-wide mb-4">
            Strength <span className="text-primary">|</span> Muscle <span className="text-primary">|</span> Skills — All Natural
          </p>
        </motion.div>
        ...
        >
          <p className="text-lg md:text-xl text-foreground/80">
            1-on-1 Online Coaching with <span className="text-primary font-semibold">[Your Name]</span>
          </p>
          <p className="text-muted-foreground mt-2">Transform in 12 Weeks</p>
        </motion.div>
      ...
      >
        <span className="text-sm uppercase tracking-widest">Scroll to learn more</span>
